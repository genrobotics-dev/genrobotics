      ...
      <div className="container mx-auto px-4 md:px-8 lg:px-12">
        <div className="flex flex-col-reverse lg:flex-row items-center lg:items-start gap-8">
          ...
          <div className="w-full lg:w-1/2 flex flex-col justify-center lg:justify-start text-center lg:text-left">
            ...
            <Link href="https://www.genroboticsfoundation.com" target="_blank" className="mt-8 px-6 py-3 bg-[#FCD901] text-black font-semibold rounded-xl w-fit mx-auto lg:mx-0">Discover Our Impact</Link>
          </div>
        </div>
      </div>
    </section>
